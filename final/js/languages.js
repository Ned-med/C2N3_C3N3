...
const arrLang = {
    'ar': {
        ...
        "heading__questions": "نبقا راد لبال؟ <br/> نستاشر عبر الهاتف مع الجهات المعنية؟ <br/> نعيط ل  141؟  <br/> اروفقًا للأعراض ديالك باش ترتاح",
        ...
        "recommandation__description": " إذا كنت كتضن انك مريض فمن الاحسن<br/> تبعد من البلايص العمومية <br/> متزورجش ناس الضعفاء الناس الكبار او المرضى <br/> بقا فدارك  <br/> التزم التعليمات لمفروضة: غسل يديك، ماسك <br/> راقب أعراض ديالك والتغيرات في درجة حرارة في جسم ديالك واستشر مع طبيب",
        ...
        "protection__title": "كفاش نحمي راسي و ناس <br/> لمعايا بشكل يومي؟",
        "protection__saluez": "نجتانب تسلام <br/> او المصافحة",
        "protection__lavez": "غسل يديك <br/>  بانتظام",
        "protection__portez": "إذا كنت مريض يجب <br/>  عليك تلبس قناع طبي",
        "protection__toussez": "نعطس و لا نكحب <br/> في المرفق أو في المنديل",
        "protection__evitez": "تجنب لمس العيون <br/> الفم الأنف",
        "protection__rassemblement": "تجنب تجمعات",
        "stay-home__desc": "ابق في دارك ، اجتنب اي إختلاط مع الآخرين. <br/>  يمكن لبعض الأشخاص <br/> ينشروا لفيروس دون الشعور بالأعراض",
        "advInformation__title": "معلومات",
        "advInformation__desc":"توصل بجميع البيانات والإحصائيات المتعلقة بالحالة <br/>  الوبائية في المغرب على البوابة الرسمية",
        "faut__savoir": "معلومات خاصك تعرفه",
        "transmet__title": "فيروس كورونا المستجد كيفاش كينتقل ",
        "transmet__gouttelettes": "عن طريق إسقاط اللعاب",
    ...
    'fr': {
        ...
        "heading__questions": "Je reste vigilant ? <br/> Je programme une téléconsultation ? <br/> J'appelle le 15 ? <br/> Faites le test pour répondre en citoyen éclairé selon vos symptômes.",
        ...
        "recommandation__description": "  évitez les endroits publics. <br/> Ne rendez pas visite aux personnes fragiles. <br/> Évitez de sortir de chez vous. <br/> Respectez les mesures barrière (lavage de main, masque). <br/> Surveillez vos symptômes, l’évolution de votre température <br/> corporelle et recherchez un avis médical.",
        ...
        "protection__title": "Comment se protéger et protéger <br> les autres au quotidien ?",
        "protection__saluez": "Saluez sans serrer la main,<br> n'embrassez personne",
        "protection__lavez": "Lavez-vous très <br> régulièrement les mains",
        "protection__portez": "Portez un masque <br> si vous êtes malade.",
        "protection__toussez": "Toussez ou éternuez dans votre coude <br/> ou dans un mouchoir",
        "protection__evitez": "Évitez de toucher les yeux <br> Bouche de nez",
        "protection__rassemblement": "Évitez les rassemblements",
        "stay-home__desc": "Restez chez vous, évitez tout contact avec les autres. <br> Certaines personnes transmettent le virus sans en ressentir <br> les symptômes.",
        "advInformation__title": "Informations",
        "advInformation__desc":"Obtenez des informations à jour <br> en provenance de Gouvernement.fr",
        "faut__savoir": "Ce qu’il faut savoir",
        "transmet__title": "Le Coronavirus COVID-19 se transmet",
        "transmet__gouttelettes": "Par la projection de gouttelettes <br> en postillonnant",
