...
const adviceAR = {
    ...
    num3 : "حالتك الصحية متتخلعش",
    num4 : "حالتك الصحية متتخلعش إذا كنت في شك ، اتصل بـ 141.",
    num5 : "ربما لا يندرج وضعك تحت Covid-19. لا تتردد في الاتصال بطبيبك إذا كنت في شك. يمكنك تكرار الاختبار إذا كان هناك عرض جديد لإعادة تقييم الموقف. للحصول على جميع المعلومات المتعلقة بـ Covid-19 ، انتقل إلى الصفحة الرئيسية.",
